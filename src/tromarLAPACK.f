c $Header: /cvs/ppgen/src/tromarLAPACK.f,v 1.2 2006/08/30 21:22:57 jelen Exp $
c***********************************************************************
...
!     write(ie,*) '& tromar'
!     write(ie,*) '& l ein         ',l,ein
!     write(ie,*) '& rc r(nrc) nrc ',rc,rc1,nrc
!     write(ie,*) '& truecore      ',truecore
!     write(ie,*) '& vir0 vir1 vir2',vir0,vir1,vir2
!     write(ie,*) '& eq1 eq2 eq3   ',eq1,eq2,eq3
!     write(ie,*) '& eq4 eq5       ',eq4,eq5
...
!       write(ie,*) '&  iteration j k',j,k
!       write(ie,*) '&  cc0 cc4    ',cc0,cc4
!       write(ie,*) '&  cc1 cc5    ',cc1,cc5
!       write(ie,*) '&  cc2 cc6    ',cc2,cc6
!       write(ie,*) '&  cc3        ',cc3
...
!     write(ie,*) '&  cc1**2 + cc2*(2l+5)', cc1**2+(2*ll+3)*cc2
...
!     write(ie,*) '& done with l                 ',l
!     write(ie,*) '& input  u, up, upp at nrc    ',bc(1),bc(2),bc(3)
!     write(ie,*) '& pseudo u, up, upp at nrc    ',
!    1  u(nrc),up(nrc),upp(nrc)
!     write(ie,*) '& truecore v(nrc)   v(nrc+1)  ',
!    1  log(truecore/pseucore)-2*cc0,vir0,v(nrc+1)
!     write(ie,*) '& pseucore vps(nrc) vps(nrc+1)',
!    1  pseucore,vps(nrc),vps(nrc+1)
