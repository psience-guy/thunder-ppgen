c $Header: /cvs/ppgen/src/moment.f,v 1.2 2006/08/30 21:22:56 jelen Exp $ 
c***********************************************************************
...
!       write(ie,*) 
!    1     '& fmom - got even no. of mesh points max, assume mmx-1'
        max=max-1
      endif
      esum=0.d0
      do i=2,max-1,2
...
c by simpson's rule
      ...
      if(mod(mmx,2) .eq. 0) then
!       write(ie,*) 
!    1     '& dmelm - got even no. of mesh points max, assume mmx-1'
        max=max-1
      endif
      esum=0.d0
      do i=2,max-1,2
