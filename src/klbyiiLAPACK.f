c $Header: /cvs/ppgen/src/klbyiiLAPACK.f,v 1.2 2006/08/30 21:22:56 jelen Exp $
c-----------------------------------------------------------------------
...
!       t1=cputime(0.d0)
        ...
        enddo
!       t1=cputime(t1)
!       write(ie,*) '& klbyii - time basis 0       ',t1
!       t1=cputime(t1)
        do n1=1,nmx
          do i=1,imx
...
!       t1=cputime(t1)
!       write(ie,*) '& klbyii - time basis 1       ',t1
!       t1=cputime(t1)
...
c           htl(n1,n2)=gaussq(gtlfgq,n1-1,n2-1)
        ...
        enddo
!       t1=cputime(t1)
!       write(ie,*) '& klbyii - time initialization',t1
      endif
...
!       t1=cputime(t1)
!       write(ie,*) '& klbyii - time nonlocal init',t1
      endif
...
!     t1=cputime(0.d0)
     ...
     &             +gltfmv(mmax,al,r,g0(1,n1),vloc,g0(1,n2))
      ...
      enddo
!     t1=cputime(t1)
!     write(ie,*) '& klbyii - time matrix setup ',t1
...
!     REAL*8 FUNCTION CPUTIME(TIME)
!     REAL*8 TIME,ETIME
!     integer mclock
!     REAL*8 TARRAY(2)
!     external mclock
!     CPUTIME = mclock()*0.01 -time
!     END
