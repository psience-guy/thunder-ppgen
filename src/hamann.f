c $Header: /cvs/ppgen/src/hamann.f,v 1.2 2006/08/30 21:22:56 jelen Exp $
c***********************************************************************
...
!     write(ie,*) '& hamann -- alam            ',alam
!     write(ie,*) '& hamann -- l,e,mode        ',l,etest,mode
!     write(ie,*) '& hamann -- mch,umch,upmch  ',mch,umch,upmch
!     write(ie,*) '& hamann -- rc,nrc,vin(nrc) ',rc,nrc,vin(nrc)
...
!       write(ie,*) '& hamann --- iter,etest   ',iter,etest
!       write(ie,*) '& hamann --- nin,mchi,uld ',nin,mchi,uld
...
!     write(ie,*) '& hamann --- vin(nrc),vin(mch) ',vin(nrc),vin(mch)
!     write(ie,*) '& hamann --- v(nrc),v(mch)     ',v(nrc),v(mch)
!     write(ie,*) '& hamann --- gam,uld           ',gam,up(mch)/u(mch)
!     write(ie,*) '& hamann --- ein,etest         ',ein,etest
!     write(ie,*) '& hamann --- returning from l= ',l
